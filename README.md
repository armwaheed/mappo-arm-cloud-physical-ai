...
| ✅ Offline regression suite | 510 tests: policy 33, integration 142, Go2 visual navigation 263, Lite3 72 |
...
cd robot-stack/unitree/go2/visual_nav && for t in test_*.py; do python3 $t; done   # 263
