...
#
# Score the two seed replicates of r1x9_224, with the same instrument as everything else.
...
for profile in go2-peer-supervised go2-navigator-default go2-run-smoke; do
  for run in r1x9_224_s1 r1x9_224_s2; do
...
echo LITE3_SEED1X9_SCORING_DONE
